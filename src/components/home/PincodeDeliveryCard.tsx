  ...
  return (
    <div className="w-full bg-[#f2fcf5]/95 backdrop-blur-xl border-2 border-emerald-200/90 shadow-xl shadow-emerald-950/5 rounded-[28px] p-5 sm:p-6 lg:p-7 mb-8 sm:mb-10 ring-1 ring-emerald-500/10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-4 flex flex-col items-start gap-3 border-b lg:border-b-0 lg:border-r border-emerald-200/80 pb-5 lg:pb-0 lg:pr-6">
          {/* Location / Supply Status Card */}
          <LocationStatusCard />

          {/* Happy Independence Day Badge */}
          <div className="inline-flex items-center gap-2 text-[#16a34a] font-bold text-xs tracking-widest uppercase bg-white px-3.5 py-1.5 rounded-full border border-emerald-300 shadow-xs">
            <span className="w-3 h-[1.5px] bg-[#16a34a]"></span>
        ...
        <div className="lg:col-span-4 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-emerald-200/80 pb-5 lg:pb-0 lg:pr-6">
          ...
          <p className="text-xs font-semibold text-slate-500 mb-3.5 ml-1">
            Enter your pincode to check delivery availability
          </p>

          {/* Form Input */}
          <form onSubmit={handleCheck} className="flex flex-col sm:flex-row gap-2.5 w-full">
            <input
              type="text"
              value={pincode}
              ...
              maxLength={6}
              className="flex-1 bg-white border-2 border-slate-200 focus:border-[#16a34a] focus:ring-2 focus:ring-[#16a34a]/20 rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 placeholder:text-slate-400 outline-none transition shadow-2xs"
            />
            <button
              type="submit"
              className="bg-[#16a34a] hover:bg-[#15803d] text-white font-extrabold px-5 py-2.5 rounded-xl text-sm flex items-center justify-center gap-2 transition shadow-md hover:shadow-lg shrink-0 active:scale-[0.98]"
            >
        ...
        <div className="lg:col-span-4 flex items-center justify-between gap-4">
          <div className="flex-1 space-y-3.5">
            ...
            <div className={`p-3.5 rounded-2xl transition-all duration-200 border-2 ${
              status === "serviceable" 
              ...
              <p className="text-xs text-slate-700 font-semibold leading-relaxed">
                If your pincode is from <br />
                <span className="font-extrabold text-[#16a34a]">Gandhinagar Sector 1–29</span> <br />
          ...
          <div className="hidden xl:flex relative w-28 h-28 shrink-0 items-center justify-center">
            <Image
