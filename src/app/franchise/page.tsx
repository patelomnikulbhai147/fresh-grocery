  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] text-purple-950 flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Banner */}
        <section className="relative bg-gradient-to-br from-purple-950 via-purple-900 to-indigo-950 text-white py-16 md:py-24 overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-amber-500/15 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/20 blur-3xl pointer-events-none" />
          ...
          <div className="mx-auto max-w-7xl px-5 md:px-8 relative z-10 text-center max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <a
                href="#inquiry-form"
                className="bg-amber-500 hover:bg-amber-400 text-purple-950 font-bold px-7 py-3.5 rounded-full text-sm transition shadow-glow-cta flex items-center gap-2"
              >
        ...
        <section className="py-16 md:py-20">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-extrabold text-purple-950">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={b.title}
                  className="bg-white rounded-3xl border border-purple-100 p-7 shadow-soft hover:shadow-lift hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
                >
                  <div>
                    <div className="w-12 h-12 rounded-2xl bg-purple-50 text-purple-800 flex items-center justify-center mb-4 border border-purple-100">
                      <b.icon className="w-6 h-6" />
                    </div>
                    <h3 className="font-display text-xl font-bold text-purple-950 mb-2">{b.title}</h3>
        ...
        <section className="py-14 md:py-18 bg-purple-50/60 border-y border-purple-100">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <div className="text-xs uppercase font-bold tracking-[0.24em] text-purple-700 mb-2">
                Simple Onboarding
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={s.step} className="bg-white rounded-3xl border border-purple-100 p-6 shadow-sm">
                  <div className="font-mono text-2xl font-black text-amber-500 mb-2">{s.step}</div>
                  <h3 className="font-display text-lg font-bold text-purple-950 mb-1">{s.title}</h3>
            ...
            <div className="grid lg:grid-cols-5 gap-10">
              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  ...
                  <h2 className="font-display text-3xl font-extrabold text-purple-950 leading-tight">
                ...
                <div className="space-y-4 pt-2">
                  <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-2xl border border-purple-100">
                    ...
                    <div>
                      ...
                      <a href="tel:+919773271029" className="font-bold text-purple-950 text-sm hover:underline">
                        +91 9773271029
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-2xl border border-purple-100">
                    ...
                    <div>
                      ...
                      <a href="tel:+916352856495" className="font-bold text-purple-950 text-sm hover:underline">
                        +91 6352856495
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-2xl border border-purple-100">
                    <Mail className="w-5 h-5 text-purple-700 shrink-0 mt-0.5" />
                    <div>
                      <div className="text-xs text-slate-500">Official Email</div>
                      <a href="mailto:flashkart.co@gmail.com" className="font-bold text-purple-950 text-sm hover:underline">
                  ...
                  <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-2xl border border-purple-100">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-purple-950 text-sm">Gandhinagar, Gujarat, India</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-[#fafaf9] rounded-3xl border border-purple-100 p-8 shadow-soft">
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <h3 className="font-display text-xl font-bold text-purple-950 mb-4">
                        Franchise Application Form
                      </h3>

                      <div>
                        <label className="block text-xs font-bold text-purple-950 mb-1.5">Your Full Name *</label>
                        <input
                          required
                          type="text"
                          value={formData.name}
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs font-bold text-purple-950 mb-1.5">City / Town</label>
                          <input
                            type="text"
                            value={formData.city}
                        ...
                        <div>
                          <label className="block text-xs font-bold text-purple-950 mb-1.5">Proposed Area / Sector</label>
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="block text-xs font-bold text-purple-950 mb-1.5">Retail / Business Experience</label>
                        <select
                      ...
                      <div>
                        <label className="block text-xs font-bold text-purple-950 mb-1.5">Message / Requirements</label>
                        <textarea
                          rows={3}
